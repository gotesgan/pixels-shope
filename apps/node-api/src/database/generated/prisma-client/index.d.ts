...
export namespace Prisma {
  ...
  */
  ...
  export interface PhonePePaymentDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * @example
     * // Get one PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * if no matches were found.
     * @param {PhonePePaymentFindUniqueOrThrowArgs} args - Arguments to find a PhonePePayment
     * @example
     * // Get one PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentFindFirstArgs} args - Arguments to find a PhonePePayment
     * @example
     * // Get one PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentFindFirstOrThrowArgs} args - Arguments to find a PhonePePayment
     * @example
     * // Get one PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentFindManyArgs} args - Arguments to filter and select certain fields only.
     * @example
     ...
     * @param {PhonePePaymentCreateArgs} args - Arguments to create a PhonePePayment.
     * @example
     * // Create one PhonePePayment
     * const PhonePePayment = await prisma.phonePePayment.create({
     *   data: {
     ...
     * @param {PhonePePaymentCreateManyArgs} args - Arguments to create many PhonePePayments.
     * @example
     * // Create many PhonePePayments
     * const phonePePayment = await prisma.phonePePayment.createMany({
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * @param {PhonePePaymentCreateManyAndReturnArgs} args - Arguments to create many PhonePePayments.
     * @example
     * // Create many PhonePePayments
     * const phonePePayment = await prisma.phonePePayment.createManyAndReturn({
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * @param {PhonePePaymentDeleteArgs} args - Arguments to delete one PhonePePayment.
     * @example
     * // Delete one PhonePePayment
     * const PhonePePayment = await prisma.phonePePayment.delete({
     *   where: {
     ...
     * @param {PhonePePaymentUpdateArgs} args - Arguments to update one PhonePePayment.
     * @example
     * // Update one PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * @param {PhonePePaymentDeleteManyArgs} args - Arguments to filter PhonePePayments to delete.
     * @example
     * // Delete a few PhonePePayments
     * const { count } = await prisma.phonePePayment.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many PhonePePayments
     * const phonePePayment = await prisma.phonePePayment.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * @param {PhonePePaymentUpdateManyAndReturnArgs} args - Arguments to update many PhonePePayments.
     * @example
     * // Update many PhonePePayments
     * const phonePePayment = await prisma.phonePePayment.updateManyAndReturn({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: [
     ...
     * @param {PhonePePaymentUpsertArgs} args - Arguments to update or create a PhonePePayment.
     * @example
     * // Update or create a PhonePePayment
     * const phonePePayment = await prisma.phonePePayment.upsert({
     *   create: {
     *     // ... data to create a PhonePePayment
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the PhonePePayment we want to update
     *   }
     * })
     */
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentCountArgs} args - Arguments to filter PhonePePayments to count.
     * @example
     * // Count the number of PhonePePayments
     * const count = await prisma.phonePePayment.count({
     *   where: {
    ...
    **/
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
    ...
    **/
     ...
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {PhonePePaymentGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
  ...
  /**
   * The delegate class that acts as a "Promise-like" for PhonePePayment.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
