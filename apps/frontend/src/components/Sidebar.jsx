...
const Sidebar = ({ isExpanded, toggleSidebar, mobileOpen, closeMobile,sendData }) => {
  const menuItems = [
      ...
      >
        ...
        <nav className="flex flex-col gap-6 px-4 mt-4">
            ...
            > <span><Home size={22} /></span>
              ...
              <span className={`hidden md:${isExpanded ? "inline" : "hidden"}`} onClick={()=>handleClick}>
                Home
              </span>
            ...
            > <span><Info size={22} /></span>
              ...
              {/* Desktop: show label only if expanded */}
              <span className={`hidden md:${isExpanded ? "inline" : "hidden"}`} onClick={()=>setItem("About")}>
                About
              </span>
            ...
            > <span><Briefcase size={22} /></span>
              ...
              {/* Desktop: show label only if expanded */}
              <span className={`hidden md:${isExpanded ? "inline" : "hidden"}`} onClick={()=>setItem("Services")}>
                Services
              </span>
            ...
            > <span><Phone size={22} /></span>
              ...
              {/* Desktop: show label only if expanded */}
              <span className={`hidden md:${isExpanded ? "inline" : "hidden"}`} onClick={()=>setItem("Contact")}>
                Contact
              </span>
