...
export default function Create() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl relative z-10"> {/* Increased max width */}
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl p-10 border border-white/40"> {/* More padding */}
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 mb-3">Create Account</h1>
            <p className="text-gray-600 text-lg">Join us and start building your online store </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Input label="Street Address" name="address" type="text" value={formData.address} onChange={handleChange} />

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Input label="City" name="city" type="text" value={formData.city} onChange={handleChange} />
              <Input label="State" name="state" type="text" value={formData.state} onChange={handleChange} />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Input label="ZIP/Postal Code" name="zipCode" type="text" value={formData.zipCode} onChange={handleChange} />
            </div>
