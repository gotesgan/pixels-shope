...
export default function HeroPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:3001/api/v1/ui/create-hero-section", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
              ...
              <div className="flex space-x-6 border-b mb-8">
                ...
                <button
                  ...
                  className={`pb-2 font-medium flex items-center space-x-2 ${
                    activeTab === "uploaded" ? "border-b-2 border-blue-600 text-blue-600" : "text-gray-600"
                  }`}
                >
              ...
              {activeTab === "form" ? (
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
                          {previewImage ? (
                            <div className="relative">
                              <img src={previewImage} alt="Hero preview" className="w-full h-48 object-cover rounded-lg" />
                              <button
                                type="button"
                                onClick={removeImage}
                ...
                <div>
                  {loading ? (
                    ...
                    <p className="text-gray-600">No uploaded hero sections found.</p>
                  ) : (
                    <div className="grid md:grid-cols-2 gap-6">
                      {uploadedData.map((item) => (
                        <div key={item.id} className="border rounded-lg p-6 bg-gray-50 relative">
                          <img
