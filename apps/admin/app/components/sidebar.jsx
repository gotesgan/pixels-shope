    ...
    >
      ...
      <div className="p-4 border-b border-slate-700">
        <div className="flex items-center justify-center">
          {isOpen && <h2 className="text-white font-semibold text-lg">Store Manager</h2>}
          {!isOpen && (
          ...
          {menuItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isActive && isOpen && <div className="ml-auto w-2 h-2 bg-white rounded-full"></div>}
      ...
      {isOpen && (
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-700">
          <div className="text-xs text-slate-400 text-center">Store Dashboard v2.0</div>
        </div>
      )}
    </aside>
  )
