...
export default function SectionCard({ title, description, icon: Icon, color, stats, actions, path }) {
    ...
    <div className="group bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="p-6 pb-4">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {actions.length > 2 && <span className="text-xs text-gray-500 px-2 py-1.5">+{actions.length - 2} more</span>}
        </div>
      </div>
