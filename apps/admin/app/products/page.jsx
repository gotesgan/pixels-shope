...
export default function ProductsPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    specifications: {},
    images: [],
    badges: [], // Added badges to formData
  })
                      ...
                      <button
                        onClick={() => {
                          ...
                          setFormData({
                            ...
                            images: [],
                            badges: product.badges || [], // Include badges when editing
                          })
