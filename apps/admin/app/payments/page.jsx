...
import { Save, CreditCard, Smartphone, DollarSign, Eye, EyeOff, ToggleLeft, ToggleRight } from "lucide-react"
...
export default function PaymentsPage() {
  ...
  const togglePhonePeStatus = async () => {
    try {
      const response = await fetch("http://localhost:4000/api/v1/phonepe/toggle-status", {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
          "Content-Type": "application/json",
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600">Configure payment methods and transaction settings</p>
                </div>
                <button
                  onClick={handleSave}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="text-2xl font-bold text-green-700">
                  ₹{transactions.reduce((sum, t) => (t.status === "COMPLETED" ? sum + t.amount : sum), 0)}
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">PhonePe Integration</h3>
                      <p className="text-sm text-gray-600">Configure PhonePe payment gateway</p>
                    </div>
                  </div>
                  <button onClick={togglePhonePeStatus} className="flex items-center space-x-2">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePhonePeSetting("clientId", e.target.value)}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) => updatePhonePeSetting("clientSecret", e.target.value)}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => updatePhonePeSetting("clientVersion", e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      disabled={!paymentSettings.phonePe.isActive}
                    >
                  ...
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => updatePhonePeSetting("testMode", e.target.checked)}
                      className="rounded"
                      disabled={!paymentSettings.phonePe.isActive}
                    />
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Configure COD payment method</p>
                    </div>
                  </div>
                  <label className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={(e) => updateCodSetting("isActive", e.target.checked)}
                      className="rounded"
                    />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateCodSetting("minOrderAmount", Number.parseInt(e.target.value))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updateCodSetting("maxOrderAmount", Number.parseInt(e.target.value))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      disabled={!paymentSettings.cod.isActive}
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Available Areas</label>
                    ...
                    <button className="mt-2 text-blue-600 hover:text-blue-700 text-sm">+ Add Area</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateGeneralSetting("taxRate", Number.parseFloat(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateGeneralSetting("shippingCharges", Number.parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateGeneralSetting("freeShippingThreshold", Number.parseInt(e.target.value))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
